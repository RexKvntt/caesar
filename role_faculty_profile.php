...
// ── Count only subjects assigned to this faculty ──
$subStmt = $pdo->prepare("SELECT COUNT(*) FROM subjects WHERE faculty = ?");
$subStmt->execute([$username]);
$subjectsCount = (int)$subStmt->fetchColumn();
    ...
    <main class="page-content">
        <section class="profile-hero">
            ...
            <div class="profile-hero-text">
                ...
                <div class="profile-hero-role">Faculty Account</div>
            </div>
        </section>
        ...
        <section class="profile-section">
            <h2 class="profile-section-title">Assignment Overview</h2>
